   ...
   return (
      <>
        ...
        <div className="flex-1 lg:ml-[264px]">
            ...
            {/* Main Section */}
            <main className="mt-10 lg:mt-0 flex flex-col lg:flex-row px-5 gap-5 py-10 min-h-[calc(100vh-80px)]">
                <div className="flex flex-col gap-5 lg:w-[70%]">
                    <div className="px-8 py-8 shadow-sm max-w-[880px] rounded-2xl bg-gradient-to-r from-green-900 via-green-800 to-green-700">
                        <div className="border-b-1 border-green-600 pb-3 mb-5">
                            <h1 className="text-3xl font-bold text-yellow-500">Welcome back!</h1>
                        </div>
                        <div>
                            <h1 className="text-3xl font-black text-gray-200">ABALOS, JERICO ANDREI</h1>
                        </div>
                        <div className="flex gap-10 mt-5 bg-green-900/[0.5] rounded-xl p-5">
                            <div>
                                <h1 className="text-[12px] font-bold text-green-400">STUDENT NO.</h1>
                                <p className="text-2xl font-black text-yellow-500">202315112</p>
                            </div>
                            <div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-5">
                        ...
                        <div className="flex flex-col pb-3 w-full shadow-sm rounded-2xl">
                            <div className="flex px-5 text-[14px] align-center justify-between  text-gray-700 rounded-t-2xl font-bold bg-orange-100 w-full overflow-hidden py-5 ">
                                <div className="flex gap-2">
                                    <CalendarCheck />
                            ...
                            <div className="flex pt-5 align-center justify-center text-center">
                                <div className="p-2 w-10 h-10 bg-yellow-100 rounded-full">
                                    <TicketCheck size={24} className="text-yellow-300" />
                                </div> 
                            </div>
                            <p className="text-center text=[14px] text-slate-700 font-semibold px-10">You have no upcoming appointments at the Registrar's Office.</p>
